...
mkdir -p $Output/Nutz/Boltz_processed
...
/data/Shared/Docking_Scripts/Boltz/Nutz.sh -i ${PWD}/Nutz -p ${PWD}/Nutz/${Prot_ID}.fasta${Use_MSA:+ -m $Use_MSA}">> Nutz/${Run_name}_${stamp}.slurm
