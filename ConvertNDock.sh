...
/data/Shared/Docking_Scripts/vina_1.2.3_linux_x86_64 --receptor $Recept --ligand $OutDIR/Ligands/$name'.pdbqt' --out $OutDIR/Docked/$name'_out.pdbqt' --cpu 10 --exhaustiveness $Exhaustiveness --center_x $CenterX --center_y $CenterY --center_z $CenterZ --size_x $SizeX --size_y $SizeY --size_z $SizeZ --num_modes 10; 
